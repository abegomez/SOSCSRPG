...
namespace Engine.Factories
{
    internal static class WorldFactory
    {
        internal static World CreateWorld()
        {
            ...
            newWorld.AddLocation(-1, -1, "Farmer's House", "This is your neighbor Farmer Ted's House.", "/Engine;component/Images/Locations/Farmhouse.png");
            newWorld.AddLocation(-2, -1, "Farmer's Field", "There are rows of corn growing here, with gant rats hiding between them.", "/Engine;component/Images/Locations/FarmFields.png");
            newWorld.AddLocation(-1, 0, "Trading Shop", "The shop of Susan the trader.", "/Engine;component/Images/Locations/Trader.png");
            newWorld.AddLocation(-0, 0, "Town Square", "You see a fountain and lots of people here.", "/Engine;component/Images/Locations/TownSquare.png");
